...
각 인사이트 항목(×2)은 반드시 아래 세 단락으로 구성한다:
...
3. **전략** — 한국 엔터테인먼트 사업자에게 의미하는 것
   ...
   **매 호마다 2개 전략을 다음 두 축으로 배분한다 (중복 금지):**

   **축 A: 독자 포지션** (아래 중 2개를 중복 없이 선택)
   ...
   **축 B: 결론 성격** (2개에서 아래 3개 중 2개 선택, 중복 금지)
   ...
   **작성 규칙:**
   ...
   - 2개 전략의 결말 톤은 서로 다르게. 동일한 어미로 끝나지 않도록.
   - 검증: 2개 전략을 나란히 놓았을 때 (1) 포지션이 다르고 (2) 결론 성격이 다르며 (3) 결말 톤이 내용과 맞는지 확인한다.
