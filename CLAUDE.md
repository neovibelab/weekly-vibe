...
- **피드 없는 IP홀더는 vibe_search로 흡수**: Sony·WBD·NBCU·Nintendo·Bandai·Crunchyroll·Pokémon·Paramount는 RSS 없음(또는 WAF) → 스크래퍼 대신 `vibe_search.py` global-en `allowed_domains`에 도메인 추가 → 일일 웹검색이 주목 뉴스를 흡수(2026-06-16 결정 — 스크래퍼 유지보수·WAF 회피).
