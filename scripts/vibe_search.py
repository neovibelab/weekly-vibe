...
TOPIC_LABELS: dict[str, str] = {
    ...
    "taste-values": "취향·가치",
    # ※ cross-industry 태그는 만들지 않는다 (2026-07-09 대표 결정 — 당일 도입·회수).
    # 엔터 레퍼런스 프레임에서 레퍼런스는 일부 신호의 속성이 아니라 전 콘텐츠의 해석 렌즈 —
    # 판정은 수집 태깅이 아니라 대시보드 보조·추천 프롬프트(nvl-vibe-radar REF_FRAME)에서.
}
